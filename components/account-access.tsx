            ...
            {!isAnonymous ? (
              <div className="space-y-4">
                <div className="rounded-2xl bg-[#e5f3ea] p-4">
                  ...
                  <p className="mt-1 text-sm text-[#587067]">
                    Puedes usar este correo para abrir tus datos en otro
                    dispositivo.
                  </p>
                </div>
                {admin && (
                  <button
                    ...
                    className="flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl bg-[#173d2d] font-semibold text-white"
                  >
                    <UserCog size={19} /> Administración
                  </button>
                )}
                <button
                  onClick={signOut}
                  className="min-h-12 w-full rounded-2xl border border-black/10 font-semibold"
                >
                  Cerrar sesión
                </button>
              </div>
